...
<main>
    ...
    <p>Here are some things you should know about working with Elvin.</p>
    
    <ol>
        <li>You are the Owner.</li>
        <li>You have a Project.</li>
        <li>The Project requirements are defined as the Program.</li>
        <li>The Architect is the Owner's Agent.</li>
        <li>The Architect represents the Owner in all matters regarding the Project.</li>
        <li>The Architect defines the Scope and Requirements for Construction of the Project in the Contract Documents.</li>
        <li>The Contract Documents fulfill the Project requirements as defined in the Program.</li>
        <li>The Contractor builds the Project in accordance with the Contract Documents.</li>
        <li>Following this process results in happiness for the Architect, Owner, and Contractor.</li>
    </ol>
